...
//private:
//	bool initialise();
//	void resize(unsigned int width, int height);
...
//{
//	mWindow = Window::create(640, 480, false, std::string());
//	mWindow->setResizeCallback(std::bind(&Game::resize, this, _1, _2));
//	//mWindow->setKeyDownCallback(std::bind(&Game::keyDown, this, _1, _2));
//	mWindow->setMouseDownCallback(std::bind(&Game::mouseDown, this, _1, _2));
//	mWindow->setMousePositionCallback(std::bind(&Game::mousePosition, this, _1, _2, _3, _4));
//	mWindow->setMouseWheelCallback(std::bind(&Game::mouseWheel, this, _1));
//
//	// Init OPENGL
//	if(ogl_LoadFunctions() == ogl_LOAD_FAILED)
//	{
//		mWindow->showMessageBox("OpenGL initialization failed.");
//		return false;
//	}
//
...
//	if(initialise())
//	{
//		auto state = StateManager::setState<T>(mWindow.get());
//		//mWindow.get()->registerListener(state);
//		StateManager::resize(mWindow->getWidth(), mWindow->getHeight());
//
...
//		auto totalTime = 0;
//
//		while(!StateManager::shouldQuit() && !mWindow->isClosed())
//		{
...
//				mWindow->setTitle(std::to_string(fps));
//				frames = 0;
//				frameCounter = 0;
//			}
//
...
//
////=========================================================================
//void Game::resize(unsigned int width, int height)
//{
...
//=========================================================================
Game::Game() : GLFWBackend(1280, 720, WindowMode::Windowed, "Game!")
{
}
...
{                                                              \
	...
	{                                                          \
		/*mWindow->showMessageBox(e->what(), mWindow->Error);*/      \
		return 1;                                              \
	}                                                          \
}